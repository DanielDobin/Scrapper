...
import { AmazonCaptchaResult, AmazonTaskExtras, Base64String, BoundingBoxResult, CaptchaResult, CapyTaskExtras, CapyTaskResult, CloudflareTurnstile, CoordinateCaptchaResult, CoordinatesTaskExtras, DataDomeCaptchaResult, DataDomeExtras, DrawAroundResult, GCImageInstruction, GCTextInstruction, GeetestExtrasV3, GeetestExtrasV4, GeetestResult, GridCaptchaResult, HCaptchaExtras, HCaptchaResult, ImageCaptchaExtras, KeyCaptcha, LanguagePool, LeminCaptchaResult, LeminTaskExtras, PendingCaptcha, ProxiedCaptchaExtras, RecaptchaV2Extras, RecaptchaResult, RecaptchaV3Extras, RotateCaptchaExtras, RotateCaptchaResult, SingleTokenResult, Task, TurnstileDefault, TurnstileResult } from "../types.js";
...
export declare class Solver {
     ...
     */
    protected newTask(body: Task): Promise<any>;
    /**
     ...
     */
    protected registerPollEntry<T>(task: number, delay?: number): Promise<CaptchaResult<T>>;
    /**
     ...
     * @throws {SolverError}
     */
    imageCaptcha(image: Base64String | Buffer, extras?: ImageCaptchaExtras): Promise<CaptchaResult<{
        text: string;
    }>>;
    /**
     ...
     * })
     */
    textCaptcha(comment: string, language?: LanguagePool): Promise<CaptchaResult<{
        text: string;
    }>>;
    /**
     ...
     */
    rotateCaptcha(image: Base64String | Buffer, extras?: RotateCaptchaExtras): Promise<CaptchaResult<RotateCaptchaResult>>;
    /**
     ...
     */
    CoordinatesCaptcha(image: Base64String | Buffer, extras?: CoordinatesTaskExtras): Promise<CaptchaResult<CoordinateCaptchaResult>>;
    /**
     ...
     */
    gridCaptcha(image: Base64String | Buffer, extras: GCImageInstruction | GCTextInstruction): Promise<CaptchaResult<GridCaptchaResult>>;
    /**
     ...
     */
    drawAround(image: Base64String | Buffer, extras: GCImageInstruction | GCTextInstruction): Promise<CaptchaResult<DrawAroundResult>>;
    /**
     ...
     */
    boundingBox(image: Base64String | Buffer, extras: GCImageInstruction | GCTextInstruction): Promise<CaptchaResult<BoundingBoxResult>>;
    /**
     ...
     *
     */
    audioTask(audio: Base64String | Buffer, lang?: "en" | "fr" | "de" | "el" | "pt" | "ru"): Promise<CaptchaResult<{
        token: string;
    }>>;
    /**
     ...
     */
    recaptchaV2<T extends boolean>(sitekey: string, pageurl: string, proxied: T | undefined, enterprise: boolean | undefined, extras: T extends false ? RecaptchaV2Extras : RecaptchaV2Extras | ProxiedCaptchaExtras): Promise<CaptchaResult<RecaptchaResult>>;
    /**
     ...
     * @returns {Promise<CaptchaResult<RecaptchaResult>>}
     */
    recaptchaV3(sitekey: string, pageurl: string, extras: RecaptchaV3Extras): Promise<CaptchaResult<RecaptchaResult>>;
    /**
     ...
     */
    hcaptcha<T extends boolean>(sitekey: string, pageurl: string, proxied: T | undefined, extras: T extends true ? HCaptchaExtras : HCaptchaExtras | ProxiedCaptchaExtras): Promise<CaptchaResult<HCaptchaResult>>;
    /**
     ...
     */
    geetest(pageurl: string, gt: string, challenge: string, proxied: boolean | undefined, extra: GeetestExtrasV3 | GeetestExtrasV4): Promise<CaptchaResult<GeetestResult>>;
    /**
     ...
     */
    turnstile<T extends boolean>(pageurl: string, sitekey: string, proxied: T | undefined, extra: T extends false ? TurnstileDefault : TurnstileDefault | ProxiedCaptchaExtras): Promise<CaptchaResult<TurnstileResult>>;
    /**
     ...
     * @returns {Promise<CaptchaResult<TurnstileResult>>}
     */
    cloudflareTurnstile<T extends boolean>(pageurl: string, sitekey: string, proxied: T | undefined, extras: T extends true ? (CloudflareTurnstile | TurnstileDefault | ProxiedCaptchaExtras) : (CloudflareTurnstile | TurnstileDefault)): Promise<CaptchaResult<TurnstileResult>>;
    /**
     ...
     */
    capypuzzle<T extends boolean>(pageurl: string, sitekey: string, proxied: T | undefined, extras: T extends true ? ProxiedCaptchaExtras | CapyTaskExtras : CapyTaskExtras): Promise<CaptchaResult<CapyTaskResult>>;
    /**
     * Solves a KeyCaptcha.
     * @param proxied {Boolean} If the captcha should be solved with a user provided proxy.
     ...
     */
    keycaptcha<T extends boolean>(proxied: T | undefined, extras: T extends true ? ProxiedCaptchaExtras | KeyCaptcha : KeyCaptcha): Promise<CaptchaResult<KeyCaptcha>>;
    /**
     ...
     */
    leminPuzzle<T extends boolean>(siteurl: string, captchaId: string, divId: string, proxied: T | undefined, extras: T extends true ? LeminTaskExtras | ProxiedCaptchaExtras : LeminTaskExtras): Promise<CaptchaResult<LeminCaptchaResult>>;
    /**
     ...
     */
    amazonCaptcha<T extends boolean>(siteurl: string, sitekey: string, iv: string, context: string, proxied: T | undefined, extras: T extends true ? ProxiedCaptchaExtras : AmazonTaskExtras | AmazonTaskExtras): Promise<CaptchaResult<AmazonCaptchaResult>>;
    /**
     ...
     */
    cyberSiARA<T extends boolean>(siteurl: string, masterurlid: string, userAgent: string, proxied: T | undefined, extras: T extends true ? ProxiedCaptchaExtras : {}): Promise<CaptchaResult<SingleTokenResult>>;
    /**
     * Solves a MTCaptcha.
     ...
     * @returns {Promise<CaptchaResult<SingleTokenResult>>}
     */
    mtCaptcha<T extends boolean>(siteurl: string, sitekey: string, proxed: T | undefined, extras: T extends true ? ProxiedCaptchaExtras : {}): Promise<CaptchaResult<SingleTokenResult>>;
    /**
     * Solves a CutCaptcha
     ...
     * @returns {Promise<CaptchaResult<SingleTokenResult>>}
     */
    cutCaptcha<T extends boolean>(siteurl: string, miserykey: string, proxied: T | undefined, extras: T extends true ? ProxiedCaptchaExtras : {}): Promise<CaptchaResult<SingleTokenResult>>;
    /**
     ...
     */
    datadome(siteurl: string, captchaurl: string, extras: DataDomeExtras): Promise<CaptchaResult<DataDomeCaptchaResult>>;
    /**
     ...
     * @returns {Promise<CaptchaResult<SingleTokenResult>>}
     */
    friendlyCaptcha<T extends boolean>(siteurl: string, sitekey: string, proxied?: T, extras?: T extends true ? ProxiedCaptchaExtras : {}): Promise<CaptchaResult<SingleTokenResult>>;
}
